...
func (x *GossipMessage) GetSourceNode() string {
	if x != nil {
		return x.SourceNode
	}
	return ""
...
func (x *PullRequest) GetRequesterNode() string {
	if x != nil {
...
type PullResponse struct {
	...
	StateMap map[string]*NodeState `protobuf:"bytes,1,rep,name=state_map,json=stateMap,proto3" json:"state_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *PullResponse) GetStateMap() map[string]*NodeState {
	if x != nil {
		return x.StateMap
	}
	return nil
...
func (x *NodeState) GetStatus() map[string]string {
	if x != nil {
		return x.Status
	}
	return nil
...
var file_gossip_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x72,
