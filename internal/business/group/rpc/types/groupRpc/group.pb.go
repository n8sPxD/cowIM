...
func (x *GroupMembersRequest) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GroupMembersResponse) GetIds() []uint32 {
	if x != nil {
		return x.Ids
	}
	return nil
...
var file_group_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x0d, 0x52, 0x03, 0x69, 0x64, 0x73, 0x32, 0x59, 0x0a, 0x05, 0x47, 0x72, 0x6f, 0x75,
